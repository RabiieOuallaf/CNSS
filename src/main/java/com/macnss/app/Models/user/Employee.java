...
public class Employee extends employee {
    ...
    public void setEmployee(String cnie, String firstName, String lastName, Date birthday, Gender gender, String email, String phone, String password,int working_days,int company_id) {
        this.cnie = cnie;
